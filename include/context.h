...
// Initialize and hold a GLFW/GL context + window.
    ...
    public:
        ...
        static void
        set_keyboard_callback(void (*fn)(int key, int scancode, int action, int mods, void *ptr), void *ptr = nullptr);

        static void set_mouse_callback(void (*fn)(double xpos, double ypos, void *ptr), void *ptr = nullptr);

        static void
        set_mouse_button_callback(void (*fn)(int button, int action, int mods, void *ptr), void *ptr = nullptr);

        static void
        set_mouse_scroll_callback(void (*fn)(double xoffset, double yoffset, void *ptr), void *ptr = nullptr);

        static void set_resize_callback(void (*fn)(int w, int h, void *ptr), void *ptr = nullptr);
