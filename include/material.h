...
// Material
    ...
    public:
        ...
        inline void
        add_texture(const std::string &uniform_name, const Texture2D &texture) { texture_map[uniform_name] = texture; }
    ...
    template
    class _API NamedHandle<MaterialImpl>; // needed for Windows DLL export
