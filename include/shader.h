...
// Shader
    ...
    public:
        ...
        ShaderImpl(const std::string &name, const fs::path &vertex_source, const fs::path &geometry_source,
        ...
        void dispatch_compute(uint32_t w, uint32_t h = 1, uint32_t d = 1,
                              GLbitfield memory_barrier_bits = GL_ALL_BARRIER_BITS) const;
    ...
    template
    class _API NamedHandle<ShaderImpl>; // needed for Windows DLL export
