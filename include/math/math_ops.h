#ifndef CPPGL_MATH_OPS_H
#define CPPGL_MATH_OPS_H
 ...
 */
    ...
    template<typename T, typename Derived>
    CPPGL_HD Eigen::Matrix<T, 3, 3> skew(
    ...
    inline CPPGL_HD float rad2deg(float x) {
